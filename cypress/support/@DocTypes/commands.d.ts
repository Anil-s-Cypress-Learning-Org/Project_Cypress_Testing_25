...
declare namespace Cypress {
    ...
    interface Chainable<Subject> {
        ...
        * @example cy.GrrenKart_GlobalSeasrch('Carrot')
        */
        GrrenKart_GlobalSeasrch(SearchText: string): Chainable<Element>;
       ...
       * @example cy.GrrenKart_AddToCart();
       *          cy.GrrenKart_AddToCart(515);
       *          cy.GrrenKart_AddToCart(increment);
       *          cy.GrrenKart_AddToCart(decremnet);
       */
        GrrenKart_AddToCart(decission?: string | number): Chainable<number, element>;
        ...
        * @example cy.GrrenKart_VegitableCostPrice('Apple')
        */
        GrrenKart_VegitableCostPrice(...SelectedVegitableName: string[]): Chainable<Element>
        ...
        * @example cy.GrrenKart_datePicker('21','05','1988');
        */
        GrrenKart_datePicker(dateIn: string, InMonth: string, InYear: string): Chainable<Element>;
